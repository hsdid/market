...
use App\Domain\Core\Search\Criteria\IntegerCriteria;
use App\Infrastructure\Core\Search\Doctrine\Context;

class IntegerCriteriaBuilder extends BaseCriteriaBuilder
{
    public function build(ContextInterface $context, CriteriaInterface $criteria): void
    {
        if (!$criteria instanceof IntegerCriteria) {
            return;
        }
    ...
    {
        return $criteria instanceof IntegerCriteria
